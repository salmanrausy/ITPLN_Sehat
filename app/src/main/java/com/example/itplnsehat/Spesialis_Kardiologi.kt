...
class Spesialis_Kardiologi : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_spesialis_kardiologi)
        ...
        IV_Back.setOnClickListener{
            ...
            if (fragment !is Home_Fragment){
                supportFragmentManager.beginTransaction()
                    .add(R.id.container_kardiologi, homeFragment, Home_Fragment::class.java.simpleName)
                    .commit()
            }
